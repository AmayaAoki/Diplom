...
namespace DiplomAE
{
    ...
    public static class FormHelper
    {
        public static void LoadPhoto(string photoName, PictureBox pictureBox)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show($"Изображение '{photoName}.jpg' не найдено в указанной папке.", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
    }
    ...
    public static class ChatHelper
    {
        public static void InitializeChat(RichTextBox writeTextBox, FlowLayoutPanel chatFlowLayoutPanel, Button sendButton, SqlConnection sqlConnection)
        {
            ...
            writeTextBox.KeyPress += (sender, e) => RichTextBox_KeyPress(sender, e, sendButton);
        ...
        private static void RichTextBox_KeyPress(object sender, KeyPressEventArgs e, Button sendButton)
        {
    ...
    public static class Notifications
    {
        ...
        public static void Notification(string sender, string recipient, string message)
        {
            string query = "INSERT INTO Notifications (ChangedBy, Recipient, Message, IsRead, Timestamp) VALUES (@sender, @recipient, @message, 0, @messageDate)";
