...
namespace DiplomAE
{
    public partial class FormAdmin : Form
    {
        ...
        public FormAdmin()
        {
            ...
            // чат 
            // ChatHelper.InitializeChat(writetext, chatList, SendB, sqlConnection);
        ...
        {
            // Отобразить MessageBox с подтверждением
            ...
            if (result == DialogResult.Yes)
            {
                ...
                // Удалить все записи из таблицы "Messenger" в базе данных
        ...
        private void DelFilterB_Click(object sender, EventArgs e)
        {
            ...
            //appointmentsBindingSource.RemoveFilter();
        }
