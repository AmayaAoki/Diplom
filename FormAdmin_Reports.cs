...
namespace DiplomAE
{
    ...
    {
        // Класс FormAdmin_Reports теперь является частью класса FormAdmin и доступен из других частей проекта
        ...
        private void FormReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    int adminID = Global.ADMINID; // Замените на нужное значение
                                                  //DateTime dateTime = DataO.Value;
